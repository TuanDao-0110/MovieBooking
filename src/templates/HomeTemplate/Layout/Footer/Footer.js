...
export default function Footer() {
    ...
    const arrTheatherInfo = _.map(theatherList, (theather) => _.pick(theather, ['maHeThongRap', 'tenHeThongRap', 'logo']))
    return (
        <footer className="py-6 bg-gray-800/80 text-gray-100 ">
            <div className="container px-6 mx-auto space-y-6 divide-y divide-gray-400 md:space-y-12 divide-opacity-50">
                <div className="grid grid-cols-12">
                    ...
                    <div className="col-span-6  md:text-left md:col-span-3">
                        <p className="pb-1 text-lg font-medium ">Theater</p>
                        <div className='grid grid-cols-2 gap-4'>

                            {arrTheatherInfo.map((item, index) => {
                                return <div key={index}>
                                    {/* <a rel="noopener noreferrer" href="#" className="hover:dark:text-blue-400">{item.maHeThongRap}</a> */}
